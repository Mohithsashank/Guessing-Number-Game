...
public class Guessing_Game {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Guess a number between 1 to 100, You will have 10 turns to find the correct number!" );
    System.out.println("Try ur luck!");
    ...
    if(guess==right_guess) {
      ...
      System.out.println("You lost! the right answer was: "+right_guess);
      return;
    }
